/*
   Capacity to Ship Packages within D Days: https://takeuforward.org/arrays/capacity-to-ship-packages-within-d-days
   ...
   The loaded weights must not exceed the maximum weight capacity of the ship. Find out the least-weight capacity
   so that you can ship all the packages within 'd' days .

   Input: N = 5, weights = [5, 4, 5, 2, 3, 4, 5, 6], d = 5. Output: 9
   Explanation: The minimum ship capacity needed to ship all packages within 5 days is 9.

   Input: N = 3, weights = [1, 2, 3, 4, 5], d = 2. Output: 9
