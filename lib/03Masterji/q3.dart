/*
     Common Toys in Two Boxes

     Question: Given two integer arrays nums1 and nums2, return an array of their intersection. Each element in
...
void main() {
  List<int> findCommon(List<int> nums1, List<int> nums2) {
    Set<int> ans = {};
  ...
  print("Output-> ${findCommon(nums1, nums2)}");
}
